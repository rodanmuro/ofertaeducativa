...
public class PasarABello {
    ...
    int FILA_INICIAL_BELLO_PONER_DATOS = 108;
    ...
    public PasarABello(String rutaMallaBase, String rutaOfertaEducativa, String rutaFormatoBello, String rutaSalida) {
